...
const ROUTE_MAP: Record<string, { crumbs: string[]; context?: string }> = {
  ...
  "/editais": { crumbs: ["Editais", "Dashboard"], context: "Radar inteligente de editais" },
  "/editais/radar": { crumbs: ["Editais", "Radar"] },
  "/editais/triagem": { crumbs: ["Editais", "Triagem"] },
  "/editais/pipeline": { crumbs: ["Editais", "Pipeline"] },
  "/editais/calendario": { crumbs: ["Editais", "Calendário"] },
  "/editais/historico": { crumbs: ["Editais", "Histórico"] },
  "/editais/monitor": { crumbs: ["Editais", "Monitor"] },
  "/editais/configuracoes": { crumbs: ["Editais", "Configurações"] },
