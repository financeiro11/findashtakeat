...
export const O_QUE_FAZ: Record<string, string> = {
  ...
  "asaas-webhook-vigia": "confere se o aviso do Asaas continua chegando, e sem erro",
  "estornos-sync-asaas": "atualiza os estornos a partir do espelho do Asaas",
  "estornos-sync-asaas-semanal": "revarre os estornos no Asaas — a rede, e a única que apaga estorno cancelado",
  ...
  "nf-corrigir-recusados": "conserta no Omie o cadastro que fez a prefeitura recusar a nota",
  "nf-emissao-diaria": "emite as NFS-e do dia, em lote",
  "nf-emissao-manha": "emite as NFS-e do que foi pago de madrugada, antes do preparo de cadastros",
  "nf-espelho-manha": "confere no Omie o desfecho das emissões da manhã",
  ...
  "nf-recusas-avisar": "manda por e-mail as recusas da prefeitura, separadas por ação",
