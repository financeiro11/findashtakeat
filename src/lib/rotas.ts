...
export const ROTAS: Record<string, { crumbs: string[]; context?: string }> = {
  ...
  "/facilities/radar": { crumbs: ["Facilities", "Radar de compras"], context: "Produtos e equipamentos · preço vigiado nas lojas" },
  "/facilities/radar/passagens": { crumbs: ["Facilities", "Radar de compras", "Passagens aéreas"], context: "Viagem marcada com teto · alerta do Google Flights" },
