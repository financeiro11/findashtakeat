...
export default function AjusteSolicitadoModal({
  ...
  return createPortal(
    ...
    >
      <div
        className="bg-background rounded-xl shadow-lg w-full max-w-[560px] max-h-[90vh] min-h-0 flex flex-col border border-border"
      ...
      >
        ...
        {/* WhatsApp area */}
        <div className="min-h-[180px] flex-1 overflow-y-auto px-5 py-4" style={{ backgroundColor: "#ECE5DD" }}>
