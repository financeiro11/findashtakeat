...
export const GUIA: readonly Verbete[] = [
  ...
  },
  {
    ...
    passos: [
      ...
      "O OS grava as taxas e razões com a divisão truncada (a Taxa de Conversão do Inside Sales de ago/26 dá 6,56% e ele grava 0%). O Hub refaz toda fórmula que o OS entrega pronta e, quando diverge, mostra o recalculado com o selo 'Hub'; a memória de cálculo diz quanto o OS tinha informado.",
    ],
    comoLer: [
