...
export const GUIA: readonly Verbete[] = [
  ...
  },
  {
    ...
    cuidados: [
      ...
      "Criar e renomear categoria, mudar o DE-PARA e apontar uma linha órfã exigem a capacidade Conciliação; os botões não aparecem para quem não a tem.",
