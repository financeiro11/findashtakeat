 ...
 */
//
// Mora em _shared para servir a tela (/assinaturas reexporta) e a camada de análise
// (analise-mensal-montar). Sem import nenhum: Deno e Vite leem o mesmo arquivo.
