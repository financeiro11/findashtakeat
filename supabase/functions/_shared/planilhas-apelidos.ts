 ...
 *
 * ESTE É O GÊMEO EM DENO de `src/lib/planilhasApelidos.ts`. Cópia verbatim: o
 * arquivo não importa nada, justamente para poder ser copiado. Quem tem teste é
 * o original (`src/lib/planilhasApelidos.test.ts`, 32 casos tirados de linhas
 * reais das planilhas) — mexeu aqui, mexa lá e rode os testes.
 * ------------------------------------------------------------------------- */
